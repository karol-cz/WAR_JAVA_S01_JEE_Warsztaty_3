...
/**
 * Servlet implementation class groupsAdminPanelAddNew
 */
@WebServlet("/solutionsAdminPanelAddNew")
public class solutionsAdminPanelAddNew extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		getServletContext().getRequestDispatcher("/solutionsAdminPanelAddNew.jsp").forward(request, response);
